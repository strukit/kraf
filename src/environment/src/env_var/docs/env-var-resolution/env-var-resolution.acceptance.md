...
## ENV_VAR_RESOLUTION-ACC-0001

Name: Import aliases are collected and deduplicated

**Links:**

- [ENV_VAR_RESOLUTION-REQ-0001](./env-var-resolution.spec.md#env_var_resolution-req-0001)
...
```gherkin
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution

  Rule: ENV_VAR_RESOLUTION-REQ-0001 — Declared import dependency collection

    Scenario: ENV_VAR_RESOLUTION-ACC-0001 — Import aliases are collected and deduplicated
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0001 — Declared import dependency collection
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0002 — Fallback variable reference is collected
...
## ENV_VAR_RESOLUTION-ACC-0003

Name: First available import alias is selected

**Links:**

- [ENV_VAR_RESOLUTION-REQ-0002](./env-var-resolution.spec.md#env_var_resolution-req-0002)
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0002 — First-found resolution

    Scenario: ENV_VAR_RESOLUTION-ACC-0003 — First available import alias is selected
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0002 — First-found resolution
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0004 — Fallback is used when no import alias has a value
...
## ENV_VAR_RESOLUTION-ACC-0005

Name: Non-empty path aliases are merged in declaration order

**Links:**

- [ENV_VAR_RESOLUTION-REQ-0003](./env-var-resolution.spec.md#env_var_resolution-req-0003)
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0003 — Path merge resolution

    Scenario: ENV_VAR_RESOLUTION-ACC-0005 — Non-empty path aliases are merged in declaration order
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0003 — Path merge resolution
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0006 — Merge fallback is used when no path is available
...
## ENV_VAR_RESOLUTION-ACC-0007

Name: Tilde fallback expands from resolved home

**Links:**

- [ENV_VAR_RESOLUTION-REQ-0004](./env-var-resolution.spec.md#env_var_resolution-req-0004)
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0004 — Placeholder expansion

    Scenario: ENV_VAR_RESOLUTION-ACC-0007 — Tilde fallback expands from resolved home
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0004 — Placeholder expansion
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0008 — Dollar fallback expands from a collected value
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0004 — Placeholder expansion
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0009 — Unresolved placeholder remains literal
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0002 — First-found resolution
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0010 — Empty first-found value is selected
...
## ENV_VAR_RESOLUTION-ACC-0011

Name: Provided canonical value precedes fallback

**Links:**

- [ENV_VAR_RESOLUTION-REQ-0005](./env-var-resolution.spec.md#env_var_resolution-req-0005)
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0005 — Source precedence and absence

    Scenario: ENV_VAR_RESOLUTION-ACC-0011 — Provided canonical value precedes fallback
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0005 — Source precedence and absence
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0012 — Provided fallback is used when canonical value is absent
      Given a provided declaration has no import aliases
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0005 — Source precedence and absence
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0013 — Host declaration without aliases ignores its canonical collected value
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0003 — Path merge resolution
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0014 — Empty path values are ignored during merge
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0003 — Path merge resolution
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0015 — Merged paths use the current platform separator
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0004 — Placeholder expansion
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0016 — Tilde expansion takes precedence and replaces only the first tilde
      Given "HOME" has the collected value "/workspace"
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0004 — Placeholder expansion
    ...
    Scenario Outline: ENV_VAR_RESOLUTION-ACC-0017 — Invalid dollar syntax remains literal
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0004 — Placeholder expansion
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0018 — Dollar expansion replaces only the first placeholder
      Given "HOME" has the collected value "/workspace"
...
## ENV_VAR_RESOLUTION-ACC-0019

Name: Pass-through forwards the first available value

**Links:**

- [ENV_VAR_RESOLUTION-REQ-0006](./env-var-resolution.spec.md#env_var_resolution-req-0006)
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0006 — Pass-through resolution

    Scenario: ENV_VAR_RESOLUTION-ACC-0019 — Pass-through forwards the first available value
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0006 — Pass-through resolution
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0020 — Pass-through absence resolves to an empty value
      Given a pass-through declaration imports "SystemRoot"
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0003 — Path merge resolution
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0021 — Unjoinable merged paths resolve to an empty value
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0005 — Source precedence and absence
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0022 — Missing source and fallback resolve to an empty value
      Given a host declaration has no import aliases
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0005 — Source precedence and absence
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0023 — Empty provided canonical value precedes fallback
      Given a provided declaration has no import aliases
...
## ENV_VAR_RESOLUTION-ACC-0024

Name: Resolved output preserves declaration and export order

**Links:**

- [ENV_VAR_RESOLUTION-REQ-0007](./env-var-resolution.spec.md#env_var_resolution-req-0007)
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0007 — Resolved output order

    Scenario: ENV_VAR_RESOLUTION-ACC-0024 — Resolved output preserves declaration and export order
...
Feature: ENV_VAR_RESOLUTION-FEAT-0001 — Environment variable resolution
  ...
  Rule: ENV_VAR_RESOLUTION-REQ-0001 — Declared import dependency collection
    ...
    Scenario: ENV_VAR_RESOLUTION-ACC-0025 — Collected keys are deduplicated and sorted
